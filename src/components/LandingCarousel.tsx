...
const carouselItems = [
  {
    ...
    hint: "medical device",
    title: "Unique Stable Design",
    description: "Glass rather than plastic ampoules store phenol without diffusion and vapour release.",
    cta: "Learn More",
    link: "/product",
  },
  {
    ...
    title: "Easy To Apply",
    description: "With a unique tapered non cotton head, designed in consultation with Podiatrists, application is accurate and fibre free.",
    cta: "View Features",
    link: "/product",
  },
  // {
